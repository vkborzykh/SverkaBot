...
export const msg = {
  ...
  helpText:
    ...
    '<b>Тарифы</b> (оформление – /subscribe):\n' +
    '🚀 «Старт» – 990 ₽/мес: до 8 сверок в месяц, HTML-отчёт и шаблон претензии\n' +
    '⚡️ «Профи» – 1 990 ₽/мес: безлимитные сверки, «Статистика», до 2 кабинетов WB\n' +
    '💼 «Бизнес» – 4 990 ₽/мес: всё из «Профи» + до 5 кабинетов, экспорт (CSV/XLSX/1C), хранение 365 дней\n\n' +
  ...
  exportNoAccessPro: 'Экспорт доступен на тарифе «Бизнес», а на «Про» — с аддоном «Экспорт для бухгалтера» (590 ₽/мес). Подключить: /subscribe',
  exportNoAccessOther: 'Экспорт доступен на тарифе «Бизнес» или на «Про» с аддоном «Экспорт для бухгалтера». Подробнее: /subscribe',
