...
export const msg = {
  ...
  errInvalidWbFile: 'Файл не похож на отчёт Wildberries. Проверьте, что вы загружаете правильный XLSX с колонками: дата, сумма к выплате.',
  errInvalidBankFile: 'Файл не похож на банковскую выписку. Проверьте, что вы загружаете правильный файл с колонками: дата, сумма, контрагент.',
