...
export const msg = {
  ...
  helpText:
    ...
    '🔵 «Профи» – 1 990 ₽/мес: безлимитные сверки, экспорт в Google Sheets, страница «Динамика», приоритетная обработка\n' +
    '🟣 «Бизнес» – 4 990 ₽/мес: всё из «Профи» + до 5 кабинетов WB, CSV-выгрузка для 1С, хранение отчётов 365 дней\n\n' +
    'Новым пользователям – пробный период 7 дней бесплатно.\n\n' +
  ...
  startLimitReached: (limit: number): string =>
    ...
    'На тарифе «Профи» сверки безлимитны, плюс экспорт в Google Sheets и приоритетная обработка.',
  upgradeToProButton: '⚡ Перейти на Профи',
