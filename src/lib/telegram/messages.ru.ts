...
export const msg = {
  ...
  helpText:
    ...
    '🚀 «Старт» – 990 ₽/мес (≈9 504 ₽/год): до 8 сверок в месяц, HTML-отчёт и шаблон претензии\n' +
    '⚡️ «Профи» – 1 990 ₽/мес (≈19 104 ₽/год): безлимитные сверки, «Статистика», до 2 кабинетов WB\n' +
    '💼 «Бизнес» – 4 990 ₽/мес (≈47 904 ₽/год): всё из «Профи» + до 5 кабинетов, экспорт (CSV/XLSX/1C), хранение 365 дней\n\n' +
